...
class env extends uvm_env;
    ...
    function void connect_phase(uvm_phase phase);
        tinyalu_agent_h.result_ap.connect(scoreboard_h.analysis_export);
        tinyalu_agent_h.cmd_ap.connect(scoreboard_h.cmd_f.analysis_export);
        tinyalu_agent_h.cmd_ap.connect(cover_alu_h.analysis_export);
